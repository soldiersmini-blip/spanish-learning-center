...
export default function NeuralPanelHeader({ title, eyebrow = 'Neural Link', backLabel, onBack, onClose, actions }: Props) {
  return (
    <header className="flex shrink-0 flex-col gap-3 border-b border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-slate-900">
